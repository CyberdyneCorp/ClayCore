...
ALIASES = {
    ...
    "MultiresSurface.from_mesh": "clay_multires_from_mesh",
    "MultiresSurface.level_counts": "clay_multires_level_counts",
    "MultiresSurface.max_level": "clay_multires_level_count",
    "MultiresSurface.base_vertex_count": "clay_multires_level_counts",
    "MultiresSurface.mesh_at_level": "clay_multires_copy_level_mesh",
    "MultiresSurface.positions_at": "clay_multires_copy_block",
    "MultiresSurface.subdivided_at": "clay_multires_copy_block",
    "MultiresSurface.normals_at": "clay_multires_copy_block",
    "MultiresSurface.detail_at": "clay_multires_serialize",
    "MultiresSurface.set_detail": "clay_multires_sculptor_stamp",
    ...
    "MultiresSurface.dirty_patches": "clay_multires_dirty_blocks",
    "MultiresSurface.clear_dirty": "clay_multires_clear_dirty",
    "MultiresSurface.serialize": "clay_multires_serialize",
    "MultiresSurface.deserialize": "clay_multires_deserialize",
    ...
    # The two factors that need an input. They were exempt while the C ABI had
    # no way to carry a std::function; they cross now as the two world-addressed
    # lattices pyclay itself takes — the SAME two objects, so the bindings agree
    # about what a cavity automask means rather than each having reached the
    # feature its own way. The exemption was removed rather than reworded: a
    # capability that has become reachable in C is exactly what this gate is
    # built to notice.
    "MeshSculptor.set_automask_inputs": "clay_mesh_sculptor_set_automask_sources",
    "DynamicSculptor.set_automask_inputs": "clay_dynamic_sculptor_set_automask_sources",
    "MultiresSculptor.set_automask_inputs": "clay_multires_sculptor_set_automask_sources",
    ...
    "StrokePreset.velocity_reference": "clay_stroke_preset_serialize",
    "Document.set_history_budget": "clay_document_set_history_budget",
    "Document.trim_history": "clay_document_trim_history",
