...
static int check_error_paths(void) {
    ...
    REQUIRE(clay_document_history_bytes(NULL, NULL) == CLAY_ERROR_INVALID_ARGUMENT);
    REQUIRE(clay_document_set_history_budget(NULL, 0) == CLAY_ERROR_INVALID_ARGUMENT);
    REQUIRE(clay_document_trim_history(NULL, 0) == CLAY_ERROR_INVALID_ARGUMENT);
