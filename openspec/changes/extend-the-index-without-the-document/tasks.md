...
- [x] 1.5 `clay_document::cull_index_locked` extends the cached index in place when it holds the only handle, and copies otherwise
...
- [x] 1.9 Update `docs/05-claycore-library.md` where the index's append is described
