## Implementation
- [x] Add bounded row classification and preserve local cell order.
- [x] Verify enumeration against independent closed-box intersections across dimensions and neighbor masks.
