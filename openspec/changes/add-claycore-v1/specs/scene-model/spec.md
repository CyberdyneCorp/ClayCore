# scene-model — Document tree, tapes, influence bounds, undo

Delta for `add-claycore-v1`. This is the library-side owner of the scene semantics ClaySpace's `add-clayspace-v1` change defines from the app's perspective; every consumer (app, CI, Python) SHALL agree on these semantics because they live here.
