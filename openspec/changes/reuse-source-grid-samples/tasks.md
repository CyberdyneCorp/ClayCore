## Implementation
- [x] Add checked full-grid sharing and preserve fallback paths.
- [x] Add independent reconstruction, evaluation-count and source-volume parity regressions.
...
- [ ] Run CPU suites, focused sanitizers, complexity and strict OpenSpec validation.
