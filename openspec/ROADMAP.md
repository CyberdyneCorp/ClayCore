...
## Where the engine is (2026-08-24, v0.52.0)

14 capabilities, 111 archived changes. Complete enough that the gaps below are
...
| **P0** | A version tag | **Still open, and now the oldest thing on this list.** The device gate has been green on main since ABI 0.39.0 (#190, the first stamp under the median-of-three statistic) and main is at **0.52.0** — thirteen minors of untagged work, including the format moving to `.clayspace` minor 13. Without a tag the team's reports cannot be pinned to a build, which is the entire reason the row exists |
