...
- 16 combine ops — add/subtract/intersect/paint plus the extended set (groove,
  ...
  5 blend profiles
- 16 deformers: twist and bend (whole-item, or **ranged** across a span and
  held beyond it, which is what a gizmo's box does), taper, displace, noise,
  elongate, and the brush-like grab, pose, pose-line and magnify (pinch is
  magnify with a negative sign)
