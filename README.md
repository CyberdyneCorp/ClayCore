...
- 16 combine ops — add/subtract/intersect/paint plus the extended set (groove,
  ...
  5 blend profiles
- 18 deformers: twist and bend (whole-item, **ranged** across a span and
  ...
  is magnify with a negative sign)
