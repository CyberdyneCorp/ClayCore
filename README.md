...
| Storage | Sparse fp16 narrow-band brick cache with dirty tracking, LOD mips, memory budget; palette-indexed colored voxel grids with cube/sphere brushes, box and line fills, mirrored edits and flood select |
