...
def main():
    R.banner("26 mask extrude — a plate pulled off a masked patch")
    ...
    R.render(with_plate(plate), "26_extract.png", eye=EYE, target=TARGET,
    ...
    for side in ("outward", "inward", "centred"):
        ...
        tiles.append(R.render_array(plate_only(piece), eye=(0.9, 1.35, 1.1),
                                    ...
                                    colors_from_field=True))
        labels.append(side)
    R.contact_sheet(tiles, "26_extract_sides.png", columns=3,
    ...
    for label, kwargs in (("hard", {}),
        ...
        tiles.append(R.render_array(plate_only(piece), eye=(0.9, 1.35, 1.1),
                                    target=(0.0, 0.55, 0.0), width=230, height=215,
                                    colors_from_field=True))
    R.contact_sheet(tiles, "26_extract_rim.png", columns=3,
    ...
    R.render_voxels(extract, "26_extract_voxels.png", eye=eye, target=target)
    ...
    R.export_model(with_plate(plate), "26_extract.ply", resolution=72)
